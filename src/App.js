...
import { Caption, Slider, Slide, Row, Col, Card, Icon, CardTitle, SideNav, SideNavItem, Button } from 'react-materialize'
    ...
    return (
      <div>
        ...
        <SideNav
          ...
          trigger={<Button node="button">SIDE NAVIGATION</Button>}
        >
          <SideNavItem
            user={{
